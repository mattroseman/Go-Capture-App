...
def process_game(files, param):
    ...
    try:
        ...
        return 1
    if image.size[0] > 640:
        image = image.resize((640, int((float(640)/image.size[0]) *
...
def main(filename, param):
    """Main function of the program."""
    return process_game(filename, param)
